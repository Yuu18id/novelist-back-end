...
class TestDetailPage extends StatefulWidget {
  final String novel;
  const TestDetailPage({super.key, required this.novel});
...
class _TestDetailPageState extends State<TestDetailPage> {
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> getNovelByName(String name) async{
    CollectionReference<Map<String, dynamic>> collection = FirebaseFirestore.instance.collection('novels');
    QuerySnapshot<Map<String, dynamic>> querySnapshot = await collection.where('name', isEqualTo: name).get();
  ...
  Future <Map<String, dynamic>?> getNovel() async{
      DocumentSnapshot<Map<String, dynamic>> document = await getNovelByName(widget.novel);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: novel['synopsis'] == null? CircularProgressIndicator() :  SingleChildScrollView(
          child: Container(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(flex: 3, child: Text(novel['author']))
                          ],
                        ),
                      ),
                      Container(
