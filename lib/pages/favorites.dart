...
class _FavoritesBodyPageState extends State<FavoritesBodyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic>? user = prov.user["data"].firstWhere((userData) => userData['username'] == prov.username, orElse: () => <String, Object>{});
    return Scaffold(
        body: Container(
            padding: EdgeInsets.all(10.0),
          child: prov.username == ''?
          Center(child: Text('Silahkan Log In untuk menambahkan daftar favorit', style: TextStyle(color: Colors.black.withOpacity(0.5)),),) :
           Column(
              children: [
                   Expanded(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(user?["favorites"][index]['img']),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
