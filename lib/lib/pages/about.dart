...
class AboutPage extends StatelessWidget {
  ...
  List members = [
    ...
    {'name': 'Ryeinaldo', 'ID': '211111677', 'type': 'Back-End Developer'},
    {
      ...
      body: GridView.count(
          ...
          children: List.generate(members.length, (index) {
            return Container(
                ...
                child: ListTile(
                  leading: members[index]['type'] == 'Front-End Developer'
                      ? Icon(Icons.design_services)
                      : members[index]['type'] == 'Back-End Developer'
                          ? Icon(Icons.code)
                          : Icon(Icons.contrast),
                  title: Text(
                      members[index]['name'] + ' (${members[index]['ID']})',
